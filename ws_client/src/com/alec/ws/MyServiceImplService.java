 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://ws.alec.com/", wsdlLocation = "http://localhost:10001/ns?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://ws.alec.com/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:10001/ns?wsdl");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://ws.alec.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.alec.com/", "MyServiceImplPort"), IMyService.class, features);
    }
